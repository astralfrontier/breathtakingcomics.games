...
5. The group plays through a Page of action
6. On each Page, each hero gets to make one Test, either in their own Panel or sharing a Panel with other Heroes
7. Adjust the status of one or more Drives depending on the Test result
8. If any Hooks were narrated, step up Trait dice if appropriate
9. At the end of Pages 1-3, move a single Drive to Red; at the end of Pages 4 and on, select one Drive and strike it
