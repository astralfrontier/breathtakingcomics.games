...
> `https://docs.google.com/spreadsheets/d/1rsOkFlM126924W7jByv6jpMdIegf65HFMxXgP4MXoR8/copy` -- Melvin

## Traits

The way I write characters is like this. Every character has 5 P's. You can stop snickering now, if you want to make jokes suitable for 14-year-olds, put them in your comic book. Call them **Traits** if you have to. So here they are:
...
Every Trait except Problems has its own die. Put a d10 on one trait, a d8 on two traits, and a d6 on whatever's left over.
...
Make sense? Good. Because here's the thing. Every time you roll one of those Trait dice, it goes down a step! A d10 becomes a d8. A d8 becomes a d6. You stop at d4, because if you went any lower you'd just be flipping coins.

"But wait," I hear you jokers asking. "What if we run outta dice?" Hooks are how you get Trait dice back. If a Hook for a particular Trait comes into play, you get to step that Trait's die back up - to its maximum, anyway. Problems are special. They don't have a die, so you get to step up any Trait you want, up to its maximum.

A Hook doesn't have to be something your character does, or something that happens to the character personally. You might write a Hook like that, but it doesn't have to work like that. It's enough for a Hook to happen in a scene.
...
You keep track of the overall state of a Drive by giving it a color: **Red** or **Green**. Green means things are going okay. The bus is safe, the villain has been pushed back, the gizmo is unplugged, whatever. Red, though, let me tell you about Red. Red means the bus is about to fall. A kid is hanging out the open door. The villain has you backed into a corner. The gizmo is counting down and it's in single digits. Hoo boy, how will our heroes get outta _this_ one?

When you start a scene, all of the Drives are sort of neutral gray - not Red or Green, because they're just starting out. But once a Drive goes to Red or Green, it never goes back to gray.

## Adding and Striking Drives

If a Drive isn't working for the group, or it feels really definitively settled, you can **strike** that Drive. Mark it as handled. You can't affect it with any more Tests. It stays however it was, gray, Red, or Green, for the rest of the scene.
...
Sometimes you write a Panel that's just meant to be appreciated for its own sake. Characters talking about their feelings, some kind of lovely visual, blah blah blah. But when things are tense, you are gonna fill a Panel with _action_.

Here's how. It's called a Test. When it's your Panel to fill, you figure out what the characters are doing - heroes and villains both. Who's taking action, what action are they taking, who's reacting to it, and how? You figure all that out and then you throw the Trait die that best fits what's going on. If a hero is leading or supporting their team, for example, that's Position. If they're using their powers, that's Powers, duh. You _can_ narrate Problems, and should if you want to wind in a Hook, but come at this from one of the Traits your hero has. The trait has to make sense. If your Personality is Brooding and you try to use that to charm someone with your winning personality... it ain't gonna work.

Once the dice hit the table, you look at what you got. On a 1 or 2, you flip a Drive to Red. Things got worse for our heroes! On a 3 or 4, flip one Drive to Red and one other to Green. That's a mixed result, not the end of the world but not the best. On a 5 or higher, flip a Drive to Green. On a 10 or higher, flip two Drives to Green! This is when things go really well.
...
If two or more heroes want to team up on something in the same Panel, great! Just keep in mind that's what the heroes are doing for the Page, in case it matters to the type of scene you're doing.

In this case, everyone rolls their trait dice. Everyone steps down their dice like usual. Use the highest roll out of everyone. Simple.
# Scenes
...
I really strongly recommend you start a new book with a Crisis Scene. This is a good way to introduce the characters, feel them out for yourself, get used to writing Drives, and so forth and so on.
...
Here's a really important thing about plot points and Drives. With the exception of your safety policies, nobody gets to veto your idea about a plot point. If they don't like it, that's their right, but if you _do_ like it, it goes in. You have to be able to create a story you'd enjoy reading.
...
First: every hero character can make a Test in only one Panel per Page. Every hero gets their own Panel to do this. You can place hero Panels in any order you like, but keep track. Don't let anyone steal the spotlight!
...
Third: you have a grace period. For the first three Pages, at the end of each Page, you flip one Green or gray Drive to Red. Every Page after that, at the end of the Page, you strike a Drive.
...
You can wind down the Crisis when about half your Drives have been struck. The group can always decide a scene is over.
...
One hero makes a Test per Panel - no group Tests allowed here. No hero can make a second Test until everyone has made their first Test, and so on.
...
You can't use Callbacks from one Issue in the same Issue. Our readers aren't that forgetful.
...
You can use what you experienced during the Issue, along with any feedback from Letters to the Editor, to tune the character you wrote. You can change any or all of their Traits, reassign the Trait dice, rewrite Hooks, and so on.
...
Taking all this into account, we put the d10 on Personality, our d6 on Powers, and a pair of d8s on Position and Past. Sure, he can kick ass, but his powers aren't why the kids are reading the book.

Sergeant Stronghold's Problems trait is "Disillusioned Doughboy". He's been around since at least the First World War and faced hate for his heritage. So let's write some Hooks to support that trait.
...
Third panel, third hero. They want to rescue the teammate from the barbecue, roll a d10, and get a three. Giant Monster Rampage goes Green because they're distracting the beast, but we'll say the fire and chaos presents an obstacle for the civilian rescue. Sure enough, that d10 drops to a d8. Doesn't matter whether you succeed or fail, the Trait die always steps down.
