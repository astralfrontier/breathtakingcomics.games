...
TAO is a take on DC's **Firestorm** character.
As a composite being, TAO's motivation is to **bring order out of chaos**.
They exist when two mortal enemies decide that a large enough danger is worth the cost of cooperating.
As such, they'll have plenty of internal conflict, even when it's obvious what needs to be done to save the city.
Outside of such a crisis, their human components will not get along well.
